...
```{r specific-wave-specific-analyses-single-beliefs}
...
`r cat0("So,", entactoFreqs$dat['none', 'Perc.Valid'], " percent prefers to bring nothing.");`

```{r specific-wave-specific-analyses-4, fig.width=14, fig.height=10, warning=FALSE, message=FALSE, error=FALSE}
